...
func main() {
	...
	// Subtask 5.2 & 5.3: Serialize with Schema Registry (auto-registers schema)
	...
	fmt.Println("✅ Task 5.1: Hardcoded Shoe object created")
	fmt.Println("✅ Task 5.2: Schema Registry serialization completed")
	fmt.Println("✅ Task 5.3: Schema automatically registered")
	fmt.Println("✅ Task 5.4: Message produced to Kafka")
	fmt.Println("✅ Task 5.5: Ready for verification")
}
